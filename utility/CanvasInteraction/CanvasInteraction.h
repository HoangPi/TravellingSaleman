...
double DisplayEdges(const char *const WindowName, Mat &canvas, std::vector<WeightedUndirectedEdge> &edges, const int WaitTime = 100, const int offset = 15, cv::Scalar Color = {50, 50, 50});